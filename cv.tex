...
%---------------------------------------------------------
  \cvhonor
    {Exibitor} % Award
    {High Performance Computing, Networking, Storage and Analysis, SC17} % Event
    {Denver, USA} % sponsor
    {Nov, 2017} % Date(s)
...
%---------------------------------------------------------
  \cvhonor
    {Exibitor} % Award
    {High Performance Computing, Networking, Storage and Analysis, SC16} % Event
    {Salt Lake City, USA} % sponsor
    {Nov, 2016} % Date(s)
